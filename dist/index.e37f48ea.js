...
const controlRecipes = async function() {
    try {
        ...
        if (!id) return;
        //loading spinner
        (0, _recipeViewJsDefault.default).renderingSpinner();
        // 0 Update results view to mark selected search result
        (0, _resultsViewJsDefault.default).update(_modelJs.getResultsPerPage());
...
const controlUpdateServing = function(newServing) {
    ...
    _modelJs.updateNewServing(newServing);
...
const controlAddRecipe = async function(newRecipe) {
    try {
        ...
        (0, _addRecipeViewJsDefault.default).renderingSpinner();
        ...
        //Close form windown
        setTimeout(function() {
            (0, _addRecipeViewJsDefault.default).toogleForm();
        }, (0, _configJs.TIME_CLOSE) * 1000);
    } catch (err) {
        (0, _addRecipeViewJsDefault.default).renderError(err.message);
    }
};
const init = function() {
    (0, _bookmarkViewJsDefault.default).addHandlerLoad(bookmarkRender);
    (0, _recipeViewJsDefault.default).addHandlerRender(controlRecipes);
    (0, _searchViewJsDefault.default).addEventHandler(controlSearchResults);
    ...
    (0, _recipeViewJsDefault.default).addHandlerUpdateServering(controlUpdateServing);
    (0, _addRecipeViewJsDefault.default).addHandlerAddRecipe(controlAddRecipe);
};
init();

},{"core-js/modules/web.immediate.js":"49tUX","./model.js":"Y4A21","./view/recipeView.js":"7Olh7","./view/searchView.js":"blwqv","./view/resultsView.js":"46Nfk","./view/paginationView.js":"9Reww","./view/bookmarkView.js":"pQnVj","./view/addRecipeView.js":"bxpSm","./config.js":"k5Hzs","regenerator-runtime":"dXNgZ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"49tUX":[function(require,module,exports) {
...
const uploadNewRecipe = async function(newRecipe) {
    try {
        const ingredientsArr = Object.entries(newRecipe).filter((entry)=>entry[0].startsWith("ingredient") && entry[1] !== "");
        const ingredients = ingredientsArr.map((ing)=>{
            ...
            const { 0: quantity , 1: unit , 2: description  } = {
                ...data
            };
            return {
        ...
        for(const property in newRecipe)if (property.startsWith("ingredient")) delete newRecipe[property];
        //prepare data
        const recipe = {
...
parcelHelpers.export(exports, "TIME_CLOSE", ()=>TIME_CLOSE);
const API_URL = "https://forkify-api.herokuapp.com/api/v2/recipes";
const TIMEOUT_SEC = 10;
const RESULTS_PER_PAGE = 10;
const KEY = "c5610d79-f4c2-4782-a0e8-087a783fb5c1";
const TIME_CLOSE = 2;
...
class RecipeView extends (0, _viewDefault.default) {
    ...
    _errorMessage = "We couldn't get this recipe. Please try again!";
    ...
    addHandlerUpdateServering(handler) {
        this._parentElement.addEventListener("click", function(e) {
            const btn = e.target.closest(".btn--increase-servings");
            if (!btn) return;
            const newServing = +btn.dataset.newServings;
...
},{"url:../../img/icons.svg":"loVOp","./View":"gAkKI","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"loVOp":[function(require,module,exports) {
...
class ResultsView extends (0, _viewDefault.default) {
    ...
    _generateMarkUp() {
        ...
        return this._data.map((el)=>{
            return `
              <li class="preview ${id === el.id ? "preview__link--active" : ""}">
                      <a
                        class="preview__link"
                        href="#${el.id}"
                      >
...
class PaginationView extends (0, _viewDefault.default) {
    ...
    _generateMarkUp() {
        ...
        if (curPage === 1 && numberPage > 1) return this._generateRightBtn(curPage + 1);
        // on last page
...
},{"./View":"gAkKI","url:../../img/icons.svg":"loVOp","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"pQnVj":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./View");
var _viewDefault = parcelHelpers.interopDefault(_view);
...
},{"./View":"gAkKI","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["fA0o9","aenu9"], "aenu9", "parcelRequire3a11")
